...
<body>
<div id="container1"> 
  <object id="FlashID" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="940" height="355">
    ...
    <!--[if !IE]>-->
    <object type="application/x-shockwave-flash" data="homepage.swf" width="940" height="355">
      <!--<![endif]-->
      <param name="quality" value="high">
      <param name="wmode" value="opaque">
      <param name="swfversion" value="6.0.65.0">
  ...
  <div id="nav">
	...
	<div id="middlearea">
      ...
      <h1>Miles for James </h1>
	    <p><strong>MILES for JAMES </strong> started off as a Facebook Group originally established to serve as a support network for anyone looking to get healthy, stay motivated, but more importantly, to be connect with James&rsquo;s friends and family. From there, MILES for JAMES grew into an organization that has a three-fold
...
others to find their own super-hero strength – what better way than to be a role
model to others? True to James, he is not only fighting for himself but for the many
people who are waiting for him.</p>
        <p><br>
          Your support through prayer, donations, or goodwill strengthens and uplifts his family and friends who are in this fight with him.  Monetary donations can be made <a href="donations/index.php" target="_blank">here</a>. To provide motivational support to James and his family, visit <a href="http://www.facebook.com" target="_blank">Facebook/Miles for James</a>.  For additional information on James and his accomplishments, visit <a href="http://www.jamesjavier.com">www.jamesjavier.com</a>.  To learn more about traumatic brain injury (TBI) and how you can help, please visit <a href="http://www.asha.org/public/speech/disorders/TBI.htm." target="_blank">www.asha.org/public/speech/disorders/TBI.htm.</a></p>
        <p>&nbsp;</p>
...
<p>&nbsp;</p>
      ...
      <div id="promohome1">
        ...
        <p><a href="events/5krace.php"><strong>2011 Race Results</strong></a><br>
          <span class="style3">September 10, 2011</span></h2>
          <br>
          <br>
        <p><strong>Race results:</strong> <a href="MFJ_AgeGroupResults.HTM">Gender/age group</a><br>
        <strong>Race results:</strong> <a href="MFJ_OverallFinishlist.HTM">Overall finish list </a></p>
        <p><a href="MFJ_AgeGroupResults.HTM" target="_blank">
          <br>
